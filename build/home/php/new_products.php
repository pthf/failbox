...
$query = "SELECT * FROM Productos p INNER JOIN Marcas m ON m.IdMarca = p.Marcas_IdMarca WHERE p.Estatus = 'Activo' AND p.Stock > 0 AND p.Oferta = 1 ORDER BY p.PrecioFailbox DESC LIMIT 20";
