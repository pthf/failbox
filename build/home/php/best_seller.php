...
$query = "SELECT * FROM Productos p 
    ...
    INNER JOIN Productos_has_Pedidos php ON php.Productos_IdProducto = p.IdProducto
    INNER JOIN Pedidos pe ON pe.IdPedido = php.Pedidos_IdPedido
    WHERE pe.Status = 1 AND p.Estatus = 'Activo' AND p.Stock > 0";
