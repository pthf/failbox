...
$query = "SELECT * FROM Productos p INNER JOIN Marcas m ON m.IdMarca = p.Marcas_IdMarca WHERE Destacado = 'SI' AND Estatus = 'Activo' AND Stock > 0 ORDER BY p.PrecioFailbox DESC LIMIT 20";
